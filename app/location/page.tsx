...
export default function LocationPage() {
  return (
    <main className="bg-[#dce5fa] text-[#00394f]">
      <section className="mx-auto grid min-h-[calc(100svh-120px)] max-w-6xl gap-10 px-4 py-12 sm:px-8 sm:py-16 lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:py-20">
        <div>
          <p className="m-0 mb-4 text-[12px] font-semibold uppercase text-[#5c76b7]">
            Visit us
          </p>
          ...
          <p className="mt-6 max-w-[420px] text-[16px] font-medium leading-[1.4] text-[#00475c]/80 sm:mt-7 sm:text-[18px]">
            {brand.microTag}. Tap below to open the shop location in Google Maps.
          </p>

          <div className="mt-9 grid gap-3 text-[17px] font-semibold text-[#00394f]/82">
            <a href={`tel:${brand.contact.phoneTel}`} className="transition-colors hover:text-[#5c76b7]">
              Call {brand.contact.phone}
            </a>
            {brand.contact.textPhone ? (
              <a
                href={`sms:${brand.contact.textPhoneTel ?? brand.contact.phoneTel}`}
                className="transition-colors hover:text-[#5c76b7]"
              >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-9 inline-flex h-14 items-center justify-center bg-[#00394f] px-7 text-[13px] font-semibold uppercase text-[#e7f0ff] transition-transform hover:scale-105"
          >
            Open in Google Maps
          </a>
        </div>

        <div className="overflow-hidden rounded-[24px] border border-[#00394f]/12 bg-[#c4d3f8] shadow-[0_26px_80px_rgba(0, 57, 79,0.12)] sm:rounded-[28px]">
          <iframe

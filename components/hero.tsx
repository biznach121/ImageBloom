...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#004a90] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#0056a0]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(0, 46, 96,0.58),rgba(0, 61, 130,0.22)_43%,rgba(0, 49, 97,0.34)),linear-gradient(0deg,rgba(0, 26, 50,0.18),rgba(0, 26, 50,0.08))]" />

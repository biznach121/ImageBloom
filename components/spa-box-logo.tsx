...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783462046/stage4/spa_imagebloom/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Image Bloom - Makeup, nails and image care">
        <Image
          src={src}
          alt="Image Bloom - Makeup, nails and image care"
          fill

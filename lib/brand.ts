...
export const brand: Brand = {
  name: "Image Bloom",
  shortName: "Image Bloom",
  microTag: "MAKEUP, NAILS AND IMAGE CARE",
  description:
    "Image Bloom is a Accra beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0242128600",
    phoneTel: "+233242128600",
    textPhone: "0242128600",
    textPhoneTel: "+233242128600",
    email: "hello@imagebloom.test",
    privacyEmail: "privacy@imagebloom.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@imagebloom", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "At Image Bloom, self-care is not a someday luxury. It is an hour that fits into your actual life and pays you back all week.",
    ...
    images: [
      {
        ...
        alt: "Image Bloom beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Image Bloom self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Image Bloom beauty ritual",
    ...
    items: [
      {
        ...
        imageAlt: "Image Bloom lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Image Bloom mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Image Bloom makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Image Bloom foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@imagebloom",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783462055/stage4/spa_imagebloom/tiktok_0.mp4",
        alt: "Image Bloom treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783462059/stage4/spa_imagebloom/tiktok_1.mp4",
        alt: "Image Bloom treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783462061/stage4/spa_imagebloom/tiktok_2.mp4",
        alt: "Image Bloom treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Image Bloom self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Image Bloom studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Image Bloom",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Image Bloom is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0242128600 and text 0242128600 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0242128600, text 0242128600, or message @imagebloom on Instagram." },
          ...
          { q: "Where are you located?", a: "Image Bloom is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@imagebloom.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Image Bloom (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@imagebloom.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Image Bloom is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@imagebloom.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Image Bloom",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0242128600", href: "tel:+233242128600" },
      { label: "Text", value: "0242128600", href: "sms:+233242128600" },
      { label: "Instagram", value: "@imagebloom", href: "https://www.tiktok.com/@imagebloom" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783462047/stage4/spa_imagebloom/avatar.jpg",
    blurb:
      "Image Bloom in Accra — makeup, nails and image care.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@imagebloom" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0242128600", href: "tel:+233242128600" },
          { label: "Text 0242128600", href: "sms:+233242128600" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Image Bloom — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
